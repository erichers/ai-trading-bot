//! Bloomberg-terminal-style AI trading backend (axum). Rust port of the FastAPI app.
//! Run: cargo run  (serves on port 8001)
...
async fn main() -> anyhow::Result<()> {
    ...
    tracing::info!("DB connected and initialized.");
